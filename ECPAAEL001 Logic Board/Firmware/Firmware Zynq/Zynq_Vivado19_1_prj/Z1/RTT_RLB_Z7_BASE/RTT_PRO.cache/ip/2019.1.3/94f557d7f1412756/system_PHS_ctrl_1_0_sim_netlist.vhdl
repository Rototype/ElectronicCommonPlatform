...
-- Date        : Tue May 12 18:27:20 2020
-- Host        : LAPTOP-D823LPN1 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_PHS_ctrl_1_0_sim_netlist.vhdl
-- Design      : system_PHS_ctrl_1_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PHS_ctrl_real is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PHS_ctrl_real;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PHS_ctrl_real is
  ...
  signal \^irq0_l2s\ : STD_LOGIC;
  signal irq0_L2S_i : STD_LOGIC;
  signal irq0_L2S_i_1_n_0 : STD_LOGIC;
  signal irq0_L2S_i_i_1_n_0 : STD_LOGIC;
  signal irq0_clr_i : STD_LOGIC;
  signal \^irq1_s2l\ : STD_LOGIC;
  signal irq1_S2L_i : STD_LOGIC;
  signal irq1_S2L_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \deb_cnt[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \deb_cnt[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \deb_cnt[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \deb_cnt[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \deb_cnt[5]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \deb_cnt[7]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \ena_dly_cnt[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ena_dly_cnt[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ena_dly_cnt[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ena_dly_cnt[4]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \ena_dly_cnt[7]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of ena_out_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of irq0_L2S_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of irq0_L2S_i_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of irq1_S2L_i_1 : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of port_pwm_out_i_10 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of port_pwm_out_i_9 : label is "soft_lutpair15";
  attribute IOB of port_pwm_out_reg : label is "TRUE";
  attribute SOFT_HLUTNM of \pwm_cnt[1]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \pwm_cnt[9]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \pwm_maxcnt[3]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \pwm_maxcnt[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \pwm_maxcnt[6]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \pwm_maxcnt[7]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \pwm_maxcnt[8]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \pwm_maxcnt[9]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \pwm_maxcnt[9]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of vld_in_i_i_1 : label is "soft_lutpair4";
begin
  irq0_L2S <= \^irq0_l2s\;
  irq1_S2L <= \^irq1_s2l\;
...
\deb_cnt[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C3F07878"
        ...
        port map (
      I0 => \deb_cnt[5]_i_2_n_0\,
      I1 => \deb_cnt[5]_i_3_n_0\,
      I2 => \deb_cnt_reg_n_0_[5]\,
      I3 => \deb_cnt[7]_i_2_n_0\,
      I4 => \deb_cnt_reg_n_0_[4]\,
      O => p_1_in(5)
    );
\deb_cnt[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\deb_cnt[5]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEF00000000FFFF"
        ...
        port map (
      I0 => \deb_cnt_reg_n_0_[6]\,
      I1 => \deb_cnt_reg_n_0_[5]\,
      I2 => \deb_cnt[5]_i_2_n_0\,
      I3 => \deb_cnt_reg_n_0_[4]\,
      I4 => port_phs_meta,
      I5 => p_0_in7_in,
...
\deb_cnt[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EAAAAAAA2AAAAAAA"
        ...
        port map (
      I0 => p_0_in7_in,
      I1 => \deb_cnt_reg_n_0_[6]\,
      I2 => \deb_cnt_reg_n_0_[4]\,
      I3 => \deb_cnt[7]_i_2_n_0\,
      I4 => \deb_cnt_reg_n_0_[5]\,
      I5 => port_phs_meta,
      O => p_1_in(7)
    );
...
\i__carry_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => \pwm_maxcnt_reg_n_0_[8]\,
      I1 => pwm_cnt_reg(8),
      I2 => pwm_cnt_reg(7),
      I3 => \pwm_maxcnt_reg_n_0_[7]\,
      I4 => pwm_cnt_reg(6),
...
irq0_L2S_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
irq0_L2S_reg: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => '1',
      D => irq0_L2S_i_1_n_0,
...
irq1_S2L_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
irq1_S2L_reg: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => '1',
      D => irq1_S2L_i_1_n_0,
...
\pwm_reg[8]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\pwm_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PHS_ctrl is
  port (
    status : out STD_LOGIC;
    vld_in : out STD_LOGIC;
    port_pwm_out : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PHS_ctrl;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PHS_ctrl is
begin
\R.PHS_ctrl\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PHS_ctrl_real
     port map (
      aclk => aclk,
      aresetn => aresetn,
      ena_in => ena_in,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "system_PHS_ctrl_1_0,PHS_ctrl,{}";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of aclk : signal is "XIL_INTERFACENAME aclk, ASSOCIATED_RESET aresetn, FREQ_HZ 1e+08, PHASE 0.000, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
begin
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PHS_ctrl
     port map (
      aclk => aclk,
      aresetn => aresetn,
      ena_in => ena_in,
