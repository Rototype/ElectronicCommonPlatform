...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_DCM_regs_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg29[1]_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \slv_reg4[0]_i_2\ : label is "soft_lutpair2";
...
\slv_reg22[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => p_0_in_0(2),
      I3 => p_0_in_0(3),
      I4 => \slv_reg22[0]_i_2_n_0\,
      I5 => \^dcm3_brake\,
      O => \slv_reg22[0]_i_1_n_0\
    );
\slv_reg22[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\slv_reg25[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00800000"
    )
        port map (
...
\slv_reg29[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BFFFFFFF80000000"
    )
        port map (
...
\slv_reg29[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\slv_reg2[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\slv_reg4[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
