...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_DCM_regs_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg10[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \slv_reg15[0]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \slv_reg16[0]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \slv_reg17[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \slv_reg17[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \slv_reg20[0]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \slv_reg21[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \slv_reg21[0]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \slv_reg22[0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \slv_reg26[0]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \slv_reg27[0]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \slv_reg29[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \slv_reg29[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \slv_reg3[0]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \slv_reg3[0]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \slv_reg4[0]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \slv_reg4[0]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \slv_reg5[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \slv_reg5[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \slv_reg8[0]_i_2\ : label is "soft_lutpair0";
...
DCM0_vld_out_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
DCM0_vld_out_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3FFFFFDF00000313"
    )
        port map (
      I0 => axi_araddr(2),
      I1 => axi_araddr(6),
...
DCM1_vld_out_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3FDFFFFF03100030"
    )
        port map (
      I0 => axi_araddr(2),
      I1 => axi_araddr(6),
...
DCM2_vld_out_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3FFFFFDF0F000010"
    )
        port map (
      I0 => axi_araddr(2),
      I1 => axi_araddr(3),
...
DCM3_vld_out_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3F7FFFFF007C0000"
    )
        port map (
      I0 => axi_araddr(2),
      I1 => axi_araddr(3),
...
DCM4_vld_out_i_1: unisim.vcomponents.LUT6
    generic map(
