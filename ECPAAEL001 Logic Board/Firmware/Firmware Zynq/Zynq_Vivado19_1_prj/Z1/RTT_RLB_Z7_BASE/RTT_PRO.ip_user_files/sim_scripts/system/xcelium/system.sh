...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../RTT_PRO.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../RTT_PRO.srcs/sources_1/bd/system/ipshared/8c62/hdl" \
       +incdir+"../../../../RTT_PRO.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../RTT_PRO.srcs/sources_1/bd/system/ipshared/8c62/hdl" \
       +incdir+"../../../../RTT_PRO.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
       +incdir+"C:/Eda_Tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include"
}
