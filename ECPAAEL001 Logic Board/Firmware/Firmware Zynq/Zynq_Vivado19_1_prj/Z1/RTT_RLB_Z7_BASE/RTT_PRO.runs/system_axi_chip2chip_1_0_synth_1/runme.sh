...
HD_PWD='D:/MW/RTT/VVD/Z/Z1/RTT_RLB_BASE/RTT_PRO.runs/system_axi_chip2chip_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_chip2chip_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_chip2chip_1_0.tcl
