...
HD_PWD='D:/MW/RTT/VVD/ZED/P0/repo/SM_alg_server/SM_alg_server.runs/mult_u22_u22_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_u22_u22.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_u22_u22.tcl
