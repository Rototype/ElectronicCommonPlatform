...
HD_PWD='D:/MW/RTT/VVD/ZED/P0/repo/SM_alg_server/SM_alg_server.runs/add_s36_fclk_lat3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_s36_fclk_lat3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_s36_fclk_lat3.tcl
