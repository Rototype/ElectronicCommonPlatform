...
HD_PWD='D:/MW/RTT/VVD/ZED/P0/repo/SM_alg_server/SM_alg_server.runs/SM_req_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SM_req_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SM_req_fifo.tcl
