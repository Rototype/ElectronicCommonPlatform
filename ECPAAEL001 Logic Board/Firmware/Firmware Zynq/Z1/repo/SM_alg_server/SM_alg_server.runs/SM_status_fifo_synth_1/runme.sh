...
HD_PWD='D:/MW/RTT/VVD/ZED/P0/repo/SM_alg_server/SM_alg_server.runs/SM_status_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SM_status_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SM_status_fifo.tcl
