...
HD_PWD='D:/MW/RTT/VVD/ZED/P0/repo/SM_alg_server/SM_alg_server.runs/div_s50_s36_lat34_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_s50_s36_lat34.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_s50_s36_lat34.tcl
