...
#
# Generated by export_simulation on Wed Apr 15 06:09:25 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './add_s36_fclk_lat3.sh' script.

./add_s36_fclk_lat3.sh -reset_run
...
./add_s36_fclk_lat3.sh -noclean_files

For more information on the script, please type './add_s36_fclk_lat3.sh -help'.
