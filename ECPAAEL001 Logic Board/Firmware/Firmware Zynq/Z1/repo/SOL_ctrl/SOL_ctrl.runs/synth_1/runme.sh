...
HD_PWD='D:/MW/RTT/VVD/ZED/P0/repo/SOL_ctrl/SOL_ctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SOL_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SOL_ctrl.tcl
