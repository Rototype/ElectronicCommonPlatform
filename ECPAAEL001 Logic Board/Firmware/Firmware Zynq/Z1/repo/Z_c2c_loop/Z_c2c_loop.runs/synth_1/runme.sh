...
HD_PWD='D:/MW/RTT/VVD/Z/Z1/repo/Z_c2c_loop/Z_c2c_loop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Z_c2c_loop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Z_c2c_loop.tcl
