...
HD_PWD='D:/MW/RTT/VVD/Z/Z1/repo/three_state/three_state.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log three_state.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source three_state.tcl
