...
HD_PWD='D:/MW/RTT/VVD/S/S_2/repo/areset_sync/areset_sync.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log areset_sync.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source areset_sync.tcl
