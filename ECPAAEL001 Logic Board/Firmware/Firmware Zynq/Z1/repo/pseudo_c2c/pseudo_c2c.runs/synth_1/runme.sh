...
HD_PWD='D:/MW/RTT/VVD/Z/Z1/repo/pseudo_c2c/pseudo_c2c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pseudo_c2c.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pseudo_c2c.tcl
