...
HD_PWD='D:/MW/RTT/VVD/Z/Z1/RTT_RLB_Z7_BASE/RTT_PRO.runs/system_util_idelay_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_util_idelay_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_util_idelay_ctrl_0_0.tcl
