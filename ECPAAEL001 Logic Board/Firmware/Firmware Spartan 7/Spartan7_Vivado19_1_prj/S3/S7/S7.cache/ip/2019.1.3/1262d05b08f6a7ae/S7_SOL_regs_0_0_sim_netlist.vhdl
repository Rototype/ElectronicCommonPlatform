...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SOL_regs_v1_0_S00_AXI is
  ...
  signal \slv_reg11[1]_i_3_n_0\ : STD_LOGIC;
  signal slv_reg11_2 : STD_LOGIC_VECTOR ( 1 to 1 );
  ...
  signal \slv_reg15[1]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \slv_reg11[1]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \slv_reg14[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \slv_reg15[1]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \slv_reg18[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \slv_reg19[1]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \slv_reg22[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \slv_reg26[0]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \slv_reg30[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \slv_reg34[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \slv_reg35[1]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \slv_reg38[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \slv_reg3[1]_i_2\ : label is "soft_lutpair1";
...
\slv_reg11[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => p_0_in_0(4),
      I1 => SOL2_vld_in,
      I2 => \slv_reg11[1]_i_3_n_0\,
      I3 => p_0_in_0(3),
      I4 => p_0_in_0(5),
      I5 => p_0_in_0(2),
      O => slv_reg11_2(1)
    );
\slv_reg11[1]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\slv_reg15[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
\slv_reg35[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
      I0 => SOL8_status(0),
      I1 => p_0_in_0(2),
      I2 => \slv_reg35[1]_i_2_n_0\,
      I3 => SOL8_vld_in,
      I4 => slv_reg35(0),
      O => \slv_reg35[0]_i_1_n_0\
    );
\slv_reg35[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\slv_reg39[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
...
\slv_reg39[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
