...
-- Command     : write_vhdl -force -mode funcsim -rename_top S7_PHS_ctrl_1_0 -prefix
--               S7_PHS_ctrl_1_0_ S7_PHS_ctrl_5_0_sim_netlist.vhdl
...
entity S7_PHS_ctrl_1_0_PHS_ctrl_real is
  port (
...
end S7_PHS_ctrl_1_0_PHS_ctrl_real;

architecture STRUCTURE of S7_PHS_ctrl_1_0_PHS_ctrl_real is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity S7_PHS_ctrl_1_0_PHS_ctrl is
  port (
    status : out STD_LOGIC;
    irq0_L2S : out STD_LOGIC;
    irq1_S2L : out STD_LOGIC;
...
end S7_PHS_ctrl_1_0_PHS_ctrl;

architecture STRUCTURE of S7_PHS_ctrl_1_0_PHS_ctrl is
begin
\R.PHS_ctrl\: entity work.S7_PHS_ctrl_1_0_PHS_ctrl_real
     port map (
      aclk => aclk,
      aresetn => aresetn,
      ena_in => ena_in,
...
entity S7_PHS_ctrl_1_0 is
  ...
  attribute NotValidForBitStream of S7_PHS_ctrl_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of S7_PHS_ctrl_1_0 : entity is "S7_PHS_ctrl_5_0,PHS_ctrl,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of S7_PHS_ctrl_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of S7_PHS_ctrl_1_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of S7_PHS_ctrl_1_0 : entity is "PHS_ctrl,Vivado 2019.1.3";
end S7_PHS_ctrl_1_0;

architecture STRUCTURE of S7_PHS_ctrl_1_0 is
...
begin
U0: entity work.S7_PHS_ctrl_1_0_PHS_ctrl
     port map (
      aclk => aclk,
      aresetn => aresetn,
      ena_in => ena_in,
