...
-- Command     : write_vhdl -force -mode funcsim -rename_top S7_DCM_ctrl_2_0 -prefix
--               S7_DCM_ctrl_2_0_ S7_DCM_ctrl_1_0_sim_netlist.vhdl
...
entity S7_DCM_ctrl_2_0_DCM_ctrl_real is
  port (
...
end S7_DCM_ctrl_2_0_DCM_ctrl_real;

architecture STRUCTURE of S7_DCM_ctrl_2_0_DCM_ctrl_real is
...
vld_in_loc_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity S7_DCM_ctrl_2_0_DCM_ctrl is
  port (
    status : out STD_LOGIC_VECTOR ( 1 downto 0 );
    vld_in : out STD_LOGIC;
...
end S7_DCM_ctrl_2_0_DCM_ctrl;

architecture STRUCTURE of S7_DCM_ctrl_2_0_DCM_ctrl is
...
begin
\R.DCM_ctrl_i\: entity work.S7_DCM_ctrl_2_0_DCM_ctrl_real
     port map (
      aclk => aclk,
      aresetn => aresetn,
      brake => brake,
...
entity S7_DCM_ctrl_2_0 is
  ...
  attribute NotValidForBitStream of S7_DCM_ctrl_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of S7_DCM_ctrl_2_0 : entity is "S7_DCM_ctrl_1_0,DCM_ctrl,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of S7_DCM_ctrl_2_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of S7_DCM_ctrl_2_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of S7_DCM_ctrl_2_0 : entity is "DCM_ctrl,Vivado 2019.1.3";
end S7_DCM_ctrl_2_0;

architecture STRUCTURE of S7_DCM_ctrl_2_0 is
...
begin
U0: entity work.S7_DCM_ctrl_2_0_DCM_ctrl
     port map (
      aclk => aclk,
      aresetn => aresetn,
      brake => brake,
