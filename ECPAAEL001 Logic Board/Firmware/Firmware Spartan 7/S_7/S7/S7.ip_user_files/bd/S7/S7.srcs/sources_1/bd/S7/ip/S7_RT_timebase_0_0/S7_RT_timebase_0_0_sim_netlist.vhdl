...
-- Command     : write_vhdl -force -mode funcsim -rename_top S7_RT_timebase_0_0 -prefix
--               S7_RT_timebase_0_0_ S7_RT_timebase_0_0_sim_netlist.vhdl
...
entity S7_RT_timebase_0_0_RT_timebase is
  port (
    ena_PHS : out STD_LOGIC;
    aresetn : in STD_LOGIC;
    aclk : in STD_LOGIC
  );
end S7_RT_timebase_0_0_RT_timebase;

architecture STRUCTURE of S7_RT_timebase_0_0_RT_timebase is
...
entity S7_RT_timebase_0_0 is
  ...
  attribute NotValidForBitStream of S7_RT_timebase_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of S7_RT_timebase_0_0 : entity is "S7_RT_timebase_0_0,RT_timebase,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of S7_RT_timebase_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of S7_RT_timebase_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of S7_RT_timebase_0_0 : entity is "RT_timebase,Vivado 2019.1.3";
end S7_RT_timebase_0_0;

architecture STRUCTURE of S7_RT_timebase_0_0 is
...
begin
U0: entity work.S7_RT_timebase_0_0_RT_timebase
     port map (
      aclk => aclk,
      aresetn => aresetn,
      ena_PHS => ena_PHS
