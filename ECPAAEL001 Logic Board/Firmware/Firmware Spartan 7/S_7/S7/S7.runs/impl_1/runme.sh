...
HD_PWD='D:/MW/RTT/VVD/S/S_7/S7/S7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S7_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S7_wrapper.tcl -notrace
