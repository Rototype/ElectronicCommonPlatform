...
-- Date        : Tue May  5 10:13:41 2020
-- Host        : LAPTOP-D823LPN1 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top S7_util_ds_buf_0_0 -prefix
--               S7_util_ds_buf_0_0_ S7_util_ds_buf_0_0_sim_netlist.vhdl
-- Design      : S7_util_ds_buf_0_0
...
entity S7_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of S7_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of S7_util_ds_buf_0_0_util_ds_buf : entity is "IBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of S7_util_ds_buf_0_0_util_ds_buf : entity is 1;
end S7_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of S7_util_ds_buf_0_0_util_ds_buf is
...
entity S7_util_ds_buf_0_0 is
  ...
  attribute NotValidForBitStream of S7_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of S7_util_ds_buf_0_0 : entity is "S7_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of S7_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of S7_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2019.1.3";
end S7_util_ds_buf_0_0;

architecture STRUCTURE of S7_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 200000000, PHASE 0.000, CLK_DOMAIN S7_util_ds_buf_0_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.S7_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
