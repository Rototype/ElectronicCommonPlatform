...
--               D:/MW/RTT/VVD/S/S_7/S7/S7.srcs/sources_1/bd/S7/ip/S7_SOL_ctrl_2_0/S7_SOL_ctrl_2_0_sim_netlist.vhdl
...
entity S7_SOL_ctrl_2_0_SOL_ctrl_real is
  port (
  ...
  attribute ORIG_REF_NAME of S7_SOL_ctrl_2_0_SOL_ctrl_real : entity is "SOL_ctrl_real";
end S7_SOL_ctrl_2_0_SOL_ctrl_real;

architecture STRUCTURE of S7_SOL_ctrl_2_0_SOL_ctrl_real is
...
\mS_cnt_reg[0]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity S7_SOL_ctrl_2_0_SOL_ctrl is
  port (
    status : out STD_LOGIC_VECTOR ( 1 downto 0 );
    vld_in : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of S7_SOL_ctrl_2_0_SOL_ctrl : entity is "SOL_ctrl";
end S7_SOL_ctrl_2_0_SOL_ctrl;

architecture STRUCTURE of S7_SOL_ctrl_2_0_SOL_ctrl is
  signal \R.SOL_ctrl_n_2\ : STD_LOGIC;
  signal rst_100_loc : STD_LOGIC;
  attribute IOB : string;
  attribute IOB of port_pwm_reg : label is "TRUE";
begin
\R.SOL_ctrl\: entity work.S7_SOL_ctrl_2_0_SOL_ctrl_real
     port map (
      aclk => aclk,
      aresetn => aresetn,
...
entity S7_SOL_ctrl_2_0 is
  ...
  attribute NotValidForBitStream of S7_SOL_ctrl_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of S7_SOL_ctrl_2_0 : entity is "S7_SOL_ctrl_2_0,SOL_ctrl,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of S7_SOL_ctrl_2_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of S7_SOL_ctrl_2_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of S7_SOL_ctrl_2_0 : entity is "SOL_ctrl,Vivado 2019.1.3";
end S7_SOL_ctrl_2_0;

architecture STRUCTURE of S7_SOL_ctrl_2_0 is
...
begin
U0: entity work.S7_SOL_ctrl_2_0_SOL_ctrl
     port map (
      aclk => aclk,
      aresetn => aresetn,
      port_pwm => port_pwm,
