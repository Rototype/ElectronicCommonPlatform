...
set_property IOSTANDARD LVCMOS25 [get_ports {SM_IRQ[0]}]

#trace C2C_X2M_IRQ_IN0
set_property PACKAGE_PIN E2 [get_ports mm2s_irq]
set_property IOSTANDARD LVCMOS25 [get_ports mm2s_irq]

#trace C2C_X2M_IRQ_OUT0
set_property PACKAGE_PIN J1 [get_ports s2mm_irq]
set_property IOSTANDARD LVCMOS25 [get_ports s2mm_irq]
...
#-- QSPI to be tuned hi-Z
#set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN F13} [get_ports QSPI_clk]
