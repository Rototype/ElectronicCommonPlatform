...
-- Date        : Mon Apr 26 16:58:46 2021
-- Host        : LAPTOP-D823LPN1 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ S7_xbar_2_sim_netlist.vhdl
-- Design      : S7_xbar_2
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_5\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[8]_i_7\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \m_axi_bready[5]_INST_0\ : label is "soft_lutpair46";
  ...
  attribute SOFT_HLUTNM of \m_axi_wvalid[5]_INST_0\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_1\ : label is "soft_lutpair2";
begin
  E(0) <= \^e\(0);
  SR(0) <= \^sr\(0);
...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_splitter__parameterized0\ is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_14\ : label is "soft_lutpair53";
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_5\ : label is "soft_lutpair53";
begin
...
\gen_arbiter.m_grant_hot_i[1]_i_14\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEFF"
    )
        port map (
...
addr_arbiter_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_addr_arbiter_sasd
     port map (
      ...
      aresetn_d_reg_1 => addr_arbiter_inst_n_8,
      \gen_arbiter.any_grant_reg_0\(0) => reg_slice_r_n_37,
      \gen_arbiter.m_amesg_i_reg[48]_0\(34 downto 0) => Q(34 downto 0),
      \gen_arbiter.m_grant_hot_i_reg[1]_0\(0) => m_ready_d0_1(2),
      \gen_arbiter.m_valid_i_reg_0\ => addr_arbiter_inst_n_35,
      \gen_arbiter.m_valid_i_reg_1\ => addr_arbiter_inst_n_41,
      \gen_arbiter.m_valid_i_reg_2\ => addr_arbiter_inst_n_50,
      \gen_arbiter.m_valid_i_reg_3\ => \gen_decerr.decerr_slave_inst_n_4\,
      \gen_arbiter.m_valid_i_reg_4\ => splitter_ar_n_1,
      \gen_axilite.s_axi_bvalid_i_reg\ => addr_arbiter_inst_n_144,
      ...
      \m_axi_bvalid[6]\ => addr_arbiter_inst_n_101,
      m_axi_bvalid_4_sp_1 => addr_arbiter_inst_n_96,
      m_axi_bvalid_5_sp_1 => addr_arbiter_inst_n_98,
...
\gen_decerr.decerr_slave_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_decerr_slave
     port map (
      ...
      \gen_arbiter.m_grant_hot_i[1]_i_3\ => addr_arbiter_inst_n_99,
      \gen_arbiter.m_grant_hot_i[1]_i_6\ => addr_arbiter_inst_n_103,
      \gen_arbiter.m_grant_hot_i[1]_i_6_0\ => addr_arbiter_inst_n_97,
      ...
      \m_ready_d[1]_i_3\ => splitter_ar_n_5,
      \m_ready_d[1]_i_3_0\ => splitter_ar_n_6,
      m_valid_i_i_2_0 => reg_slice_r_n_39,
      mi_bvalid(0) => mi_bvalid(8),
      mi_wready(0) => mi_wready(8),
      \s_axi_bvalid[0]\ => addr_arbiter_inst_n_98,
      \s_axi_bvalid[0]_0\ => addr_arbiter_inst_n_100,
      \s_axi_bvalid[0]_1\ => addr_arbiter_inst_n_96,
      \s_axi_bvalid[0]_2\ => addr_arbiter_inst_n_101,
...
splitter_ar: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_splitter__parameterized0\
     port map (
      aclk => aclk,
      aresetn_d => aresetn_d,
      \gen_arbiter.m_grant_hot_i[1]_i_3\ => reg_slice_r_n_40,
      m_atarget_enc(3 downto 0) => m_atarget_enc(3 downto 0),
      ...
      \m_ready_d_reg[1]_3\ => addr_arbiter_inst_n_102,
...
splitter_aw: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_splitter
     port map (
      aclk => aclk,
      \gen_arbiter.m_grant_hot_i[1]_i_6_0\ => reg_slice_r_n_40,
      \gen_arbiter.m_grant_hot_i[1]_i_6_1\ => splitter_ar_n_4,
      \gen_arbiter.m_grant_hot_i_reg[1]\ => addr_arbiter_inst_n_35,
      \gen_arbiter.m_grant_hot_i_reg[1]_0\ => \gen_decerr.decerr_slave_inst_n_8\,
      \gen_arbiter.m_grant_hot_i_reg[1]_1\ => addr_arbiter_inst_n_102,
      m_atarget_enc(3 downto 0) => m_atarget_enc(3 downto 0),
      m_axi_awready(2 downto 0) => m_axi_awready(4 downto 2),
      \m_axi_awready[4]\(0) => m_ready_d0_1(2),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar is
  ...
  attribute C_M_AXI_ADDR_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar : entity is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
  attribute C_M_AXI_READ_CONNECTIVITY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  ...
  attribute C_M_AXI_WRITE_CONNECTIVITY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "S7_xbar_2,axi_crossbar_v2_1_20_axi_crossbar,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute C_M_AXI_ADDR_WIDTH : string;
  attribute C_M_AXI_ADDR_WIDTH of inst : label is "256'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
  attribute C_M_AXI_READ_CONNECTIVITY of inst : label is "256'";
  attribute C_M_AXI_READ_ISSUING : string;
  ...
  attribute C_M_AXI_WRITE_CONNECTIVITY : string;
  attribute C_M_AXI_WRITE_CONNECTIVITY of inst : label is "256'";
  attribute C_M_AXI_WRITE_ISSUING : string;
  ...
  attribute X_INTERFACE_PARAMETER of s_axi_rready : signal is "XIL_INTERFACENAME S00_AXI, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 100000000, ID_WIDTH 0, ADDR_WIDTH 32, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 1, NUM_WRITE_OUTSTANDING 1, MAX_BURST_LENGTH 1, PHASE 0.0, CLK_DOMAIN S7_util_ds_buf_0_0_IBUF_OUT, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0, XIL_INTERFACENAME S01_AXI, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 100000000, ID_WIDTH 0, ADDR_WIDTH 32, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 1, NUM_WRITE_OUTSTANDING 1, MAX_BURST_LENGTH 1, PHASE 0.0, CLK_DOMAIN S7_util_ds_buf_0_0_IBUF_OUT, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
