...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_addr_arbiter_sasd is
  ...
  signal \gen_addr_decoder.addr_decoder_inst/gen_target[7].gen_region[0].gen_comparator_static.gen_addr_range.addr_decode_comparator/sel_4__2\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_17\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[7]_i_7\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \m_atarget_hot[7]_i_8\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \m_axi_bready[1]_INST_0\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \m_axi_bready[2]_INST_0\ : label is "soft_lutpair49";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[18]_INST_0\ : label is "soft_lutpair38";
  ...
  attribute SOFT_HLUTNM of \m_axi_wvalid[1]_INST_0\ : label is "soft_lutpair50";
  ...
  attribute SOFT_HLUTNM of \s_axi_wready[1]_INST_0_i_4\ : label is "soft_lutpair12";
begin
  SR(0) <= \^sr\(0);
  any_error <= \^any_error\;
...
\m_atarget_enc[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000FFEA0000"
        ...
        port map (
      I0 => \gen_addr_decoder.addr_decoder_inst/gen_target[7].gen_region[0].gen_comparator_static.gen_addr_range.addr_decode_comparator/sel_4__2\,
...
\m_atarget_hot[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \m_atarget_hot[7]_i_4_n_0\,
      I3 => aa_grant_any,
      I4 => \gen_addr_decoder.addr_decoder_inst/gen_target[7].gen_region[0].gen_comparator_static.gen_addr_range.addr_decode_comparator/sel_4__2\,
      O => D(7)
    );
...
\m_atarget_hot[7]_i_5\: unisim.vcomponents.LUT4
    generic map(
      ...
      O => \gen_addr_decoder.addr_decoder_inst/gen_target[7].gen_region[0].gen_comparator_static.gen_addr_range.addr_decode_comparator/sel_4__2\
    );
...
addr_arbiter_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_addr_arbiter_sasd
     port map (
      ...
      \gen_arbiter.grant_rnw_reg_0\ => addr_arbiter_inst_n_38,
      ...
      \m_axi_arready[6]\ => addr_arbiter_inst_n_50,
      ...
      \m_axi_wready[7]\ => addr_arbiter_inst_n_54,
      m_axi_wready_2_sp_1 => addr_arbiter_inst_n_53,
      m_axi_wready_4_sp_1 => addr_arbiter_inst_n_55,
...
\gen_decerr.decerr_slave_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_decerr_slave
     port map (
      ...
      \f_mux_return__2\ => \f_mux_return__2\,
      \f_mux_return__6\ => \f_mux_return__6\,
      \gen_arbiter.m_grant_hot_i[1]_i_5\ => addr_arbiter_inst_n_49,
      \gen_arbiter.m_grant_hot_i[1]_i_5_0\ => addr_arbiter_inst_n_50,
      \gen_arbiter.m_grant_hot_i[1]_i_5_1\ => addr_arbiter_inst_n_51,
      ...
      m_valid_i_reg_2 => addr_arbiter_inst_n_38,
      mi_arvalid_en => mi_arvalid_en,
      mi_bvalid(0) => mi_bvalid(8),
      mi_wready(0) => mi_wready(8),
      ...
      \s_axi_wready[0]\ => addr_arbiter_inst_n_53,
      \s_axi_wready[0]_0\ => addr_arbiter_inst_n_54,
      \s_axi_wready[0]_1\ => addr_arbiter_inst_n_55,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar is
  ...
  attribute C_M_AXI_BASE_ADDR of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar : entity is "512'";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
