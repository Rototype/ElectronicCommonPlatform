...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_addr_arbiter_sasd is
  port (
    ...
    \gen_arbiter.m_amesg_i_reg[17]_1\ : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_15\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_16\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[0]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \m_atarget_hot[1]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \m_atarget_hot[1]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \m_atarget_hot[2]_i_2\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \m_axi_bready[0]_INST_0\ : label is "soft_lutpair46";
  ...
  attribute SOFT_HLUTNM of \s_arvalid_reg[1]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \s_awvalid_reg[1]_i_1\ : label is "soft_lutpair21";
...
\m_atarget_enc[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      O => \gen_arbiter.m_amesg_i_reg[17]_1\(0)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_splitter is
  ...
  attribute SOFT_HLUTNM of \m_ready_d[2]_i_1\ : label is "soft_lutpair61";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_register_slice_v2_1_19_axic_register_slice is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_12\ : label is "soft_lutpair56";
  ...
  attribute SOFT_HLUTNM of \m_ready_d[0]_i_3\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of m_valid_i_i_1 : label is "soft_lutpair55";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_crossbar_sasd is
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_5\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_6\ : label is "soft_lutpair64";
begin
addr_arbiter_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_addr_arbiter_sasd
     port map (
      ...
      \gen_arbiter.m_amesg_i_reg[17]_0\ => addr_arbiter_inst_n_66,
      \gen_arbiter.m_amesg_i_reg[17]_1\(0) => any_error,
      \gen_arbiter.m_amesg_i_reg[17]_2\ => addr_arbiter_inst_n_104,
      \gen_arbiter.m_amesg_i_reg[18]_0\ => addr_arbiter_inst_n_64,
      \gen_arbiter.m_amesg_i_reg[18]_1\ => addr_arbiter_inst_n_103,
      ...
      \m_axi_arready[6]\ => addr_arbiter_inst_n_46,
      m_axi_arready_2_sp_1 => addr_arbiter_inst_n_45,
      m_axi_arready_4_sp_1 => addr_arbiter_inst_n_47,
      ...
      \m_axi_wready[7]\ => addr_arbiter_inst_n_50,
      m_axi_wready_2_sp_1 => addr_arbiter_inst_n_49,
      m_axi_wready_4_sp_1 => addr_arbiter_inst_n_51,
...
\gen_decerr.decerr_slave_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_decerr_slave
     port map (
      ...
      \f_mux_return__2\ => \f_mux_return__2\,
      \f_mux_return__6\ => \f_mux_return__6\,
      \gen_arbiter.m_grant_hot_i[1]_i_5\ => addr_arbiter_inst_n_45,
      \gen_arbiter.m_grant_hot_i[1]_i_5_0\ => addr_arbiter_inst_n_46,
      \gen_arbiter.m_grant_hot_i[1]_i_5_1\ => addr_arbiter_inst_n_47,
      ...
      m_valid_i_reg_2 => addr_arbiter_inst_n_34,
      mi_arvalid_en => mi_arvalid_en,
      mi_bvalid(0) => mi_bvalid(8),
      mi_wready(0) => mi_wready(8),
      ...
      \s_axi_wready[0]\ => addr_arbiter_inst_n_49,
      \s_axi_wready[0]_0\ => addr_arbiter_inst_n_50,
      \s_axi_wready[0]_1\ => addr_arbiter_inst_n_51,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar is
  ...
  attribute C_M_AXI_ADDR_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_20_axi_crossbar : entity is "512'";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
