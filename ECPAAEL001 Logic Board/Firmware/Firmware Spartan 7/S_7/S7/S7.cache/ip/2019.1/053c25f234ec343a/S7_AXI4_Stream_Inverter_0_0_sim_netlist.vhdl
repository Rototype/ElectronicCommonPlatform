...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Inverter is
  ...
  signal \inverted_tdata_MSB[7]_i_10_n_0\ : STD_LOGIC;
  ...
  signal \packet_counter_vct_reg[31]_i_1_n_3\ : STD_LOGIC;
  signal \packet_counter_vct_reg[31]_i_1_n_6\ : STD_LOGIC;
  signal \packet_counter_vct_reg[31]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \NLW_packet_counter_vct_reg[31]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_packet_counter_vct_reg[31]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \image_length_vct[31]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \inverted_tdata_2ndB[1]_i_1\ : label is "soft_lutpair0";
begin
...
\inverted_tdata_MSB[7]_i_10\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \^counter\(5),
      I5 => \^counter\(4),
      O => \inverted_tdata_MSB[7]_i_10_n_0\
    );
...
\inverted_tdata_MSB[7]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \inverted_tdata_MSB[7]_i_6_n_0\,
      I2 => \inverted_tdata_MSB[7]_i_7_n_0\,
      I3 => \inverted_tdata_MSB[7]_i_8_n_0\,
      I4 => \inverted_tdata_MSB[7]_i_9_n_0\,
      I5 => \inverted_tdata_MSB[7]_i_10_n_0\,
      O => \inverted_tdata_MSB[7]_i_4_n_0\
    );
\inverted_tdata_MSB[7]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\inverted_tdata_MSB[7]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\inverted_tdata_MSB[7]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\packet_counter_vct_reg[30]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => inverted_tdata_MSB0,
      D => \packet_counter_vct_reg[31]_i_1_n_7\,
      Q => \^counter\(28),
      R => \inverted_tdata_MSB[7]_i_1_n_0\
    );
\packet_counter_vct_reg[31]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => inverted_tdata_MSB0,
      D => \packet_counter_vct_reg[31]_i_1_n_6\,
      Q => \^counter\(29),
      R => \inverted_tdata_MSB[7]_i_1_n_0\
    );
\packet_counter_vct_reg[31]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \packet_counter_vct_reg[29]_i_1_n_0\,
      CO(3 downto 1) => \NLW_packet_counter_vct_reg[31]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \packet_counter_vct_reg[31]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_packet_counter_vct_reg[31]_i_1_O_UNCONNECTED\(3 downto 2),
      O(1) => \packet_counter_vct_reg[31]_i_1_n_6\,
      O(0) => \packet_counter_vct_reg[31]_i_1_n_7\,
      S(3 downto 2) => B"00",
