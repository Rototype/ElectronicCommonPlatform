...
HD_PWD='D:/MW/RTT/VVD/S/S_4/sim_DDR/sim_DDR.runs/mmcm_z_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mmcm_z.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mmcm_z.tcl
