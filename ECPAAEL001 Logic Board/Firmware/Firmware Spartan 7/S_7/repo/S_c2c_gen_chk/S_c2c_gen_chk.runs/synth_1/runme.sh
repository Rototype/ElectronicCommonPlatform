...
HD_PWD='D:/MW/RTT/VVD/S/S_3/repo/S_c2c_gen_chk/S_c2c_gen_chk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S_c2c_gen_chk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S_c2c_gen_chk.tcl
