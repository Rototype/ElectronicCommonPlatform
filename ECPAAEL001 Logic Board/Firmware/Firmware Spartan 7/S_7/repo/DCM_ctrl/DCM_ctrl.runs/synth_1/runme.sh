...
HD_PWD='D:/MW/RTT/VVD/S/S_2/repo/DCM_ctrl/DCM_ctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DCM_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DCM_ctrl.tcl
