...
HD_PWD='D:/MW/RTT/VVD/S/S_3/repo/SM_ctrl/SM_ctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SM_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SM_ctrl.tcl
