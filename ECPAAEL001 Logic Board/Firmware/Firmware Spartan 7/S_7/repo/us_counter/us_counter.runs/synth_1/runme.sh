...
HD_PWD='D:/MW/RTT/VVD/ZED/P0/repo/us_counter/us_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log us_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source us_counter.tcl
