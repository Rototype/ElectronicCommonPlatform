...
void ddr_cfg_phy(void) {
	...
	reg32_write(0x3c240290,0xffffffff);
	reg32_write(0x3c240294,0xffffffff);
	reg32_write(0x3c240298,0xffffffff);
	...
	reg32_write(0x3c0800e8,0x2);
	reg32_write(0x3c080224,0xffffffff);
	reg32_write(0x3c080220,0xffffffff);
